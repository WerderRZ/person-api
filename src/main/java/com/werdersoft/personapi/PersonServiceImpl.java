...
public class PersonServiceImpl implements PersonService {
    ...
    public List<Person> getAllPersons() {
        log.info("Entering getAllPersons method");
        return toList(personRepository.findAll());
    }

    @Override
    public Person getPersonById(Long id) {
        log.info("Entering getPersonById method");
        return findPersonById(id);
    }

    @Override
    public Person createPerson(Person person) {
        log.info("Entering createPerson method");
        return personRepository.save(person);
    }

    @Override
    public Person updatePersonById(Long id, Person person) {
        log.info("Entering updatePersonById method");
    ...
    public void deletePersonById(Long id) {
        log.info("Entering deletePersonById method");
        Person findedPerson = findPersonById(id);
        personRepository.delete(findedPerson);
    }

    private Person findPersonById(Long id) {
        log.info("Entering findPersonById method");
